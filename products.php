...
<head>
    ...
    <meta name="msapplication-TileImage" content="assets/images/" />
            ...
            <div class="row">
                <div class="col-lg-9 order-lg-last col-md-12 order-md-first">
                    ...
                    <div class="shop-bottom-area">
                        <div class="row">
                            <div class="col-lg-4  col-md-6 col-sm-6 col-xs-6 mb-15px">
                                <div class="product mb-25px">
                                    <div class="thumb">
                                        <a href="shop-left-sidebar.html" class="image">
                                            <img src="assets/images/product-image/product.webp" alt="Product" />
                                            <img class="hover-image" src="assets/images/product-image/product.webp" alt="Product" />
                                        </a>
                                        <span class="badges">
                        ...
                        <div class="pro-pagination-style text-center mb-md-30px mb-lm-30px mt-30px" >
                            <ul>
                                <li>
