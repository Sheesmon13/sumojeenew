...
<head>
    ...
    <title>Sumojee || Products Details</title>
</head>
...
<div class="offcanvas-overlay"></div>
    ...
    <div class="product-details-area pad-all pt-100px pb-100px">
        <div class="container">
            <div class="row">
                    ...
                    <div class="swiper-container zoom-top">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide zoom-image-hover">
                                <img class="img-responsive m-auto" src="assets/images/product-image/products.webp" alt="img">
                            </div>
                            <div class="swiper-slide zoom-image-hover">
                                <img class="img-responsive m-auto" src="assets/images/product-image/products.webp" alt="img">
                            </div>
                    ...
                    <div class="swiper-container zoom-thumbs slider-nav-style-1 small-nav mt-15px mb-15px">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img class="img-responsive m-auto" src="assets/images/product-image/product0.webp" alt="img">
                            </div>
                            <div class="swiper-slide">
                                <img class="img-responsive m-auto" src="assets/images/product-image/product0.webp" alt="img">
                            </div>
                    ...
                    <div class="product-details-content quickview-content">
                        ...
                        <div class="pro-details-quality">
                            ...
                            <div class="pro-details-cart">
                                <button class="add-cart btn btn-primary ml-4" href="#"> Add To
                                    Cart</button>
                            </div>
                        </div>
                        ...
                        <div class="pro-details-policy">
                            <ul>
                                <li><img src="assets/images/icon/policy.png" alt="" /><span>Security Policy (Edit With
                                        Customer Reassurance Module)</span></li>
                                <li><img src="assets/images/icon/policy-2.png" alt="" /><span>Delivery Policy (Edit
                                        With Customer Reassurance Module)</span></li>
                                <li><img src="assets/images/icon/policy-3.png" alt="" /><span>Return Policy (Edit With
                                        Customer Reassurance Module)</span></li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="description-review-area pb-100px">
        <div class="container">
